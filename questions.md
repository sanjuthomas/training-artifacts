...
| # | Question | Sanju's Solution | Bob's comment |
|---|---|---|---|
| 1 | How will we observe the feed pipeline end-to-end (ingest → stage → Kafka → ETL → query)? | SLO Dashboard using [Observability Mesh](http://observabilitymesh.com/) | TODO |
